...
console.log("Deploying SkillSprintRewards...");
// Generate a unique alias or check if alias can be ignored
const rewardsContractId = deployContract(rewardsWasmPath, "skill_sprint_rewards_" + Date.now().toString().slice(-4));
console.log(`Deployed SkillSprintRewards to: ${rewardsContractId}`);

console.log("Deploying SkillSprintLedger...");
const ledgerContractId = deployContract(ledgerWasmPath, "skill_sprint_ledger_" + Date.now().toString().slice(-4));
console.log(`Deployed SkillSprintLedger to: ${ledgerContractId}`);
...
console.log("Initializing SkillSprintRewards...");
...
console.log("Initializing SkillSprintLedger...");
execFileSync("stellar", [
  "contract",
  "invoke",
  "--id",
